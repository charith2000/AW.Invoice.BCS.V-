export interface ConsumerMapAndVerificationSuitFieldModel {
  createdAt: string;
  createdBy: string;
  ...
  consumerSuitFiledTempId: number;
  consumerSuitFiledTemp: ConsumerSuitFiledTemp;
  consumerSuitFiledValueVerifications: ConsumerSuitFiledValueVerification[];
}

export interface ConsumerSuitFiledValueVerification {
  id: number;
  rules: Rule[];
  columns: string;
  verification: boolean;
  consumerSuitFiledId: number;
  consumerSuitFiled: string;
}
