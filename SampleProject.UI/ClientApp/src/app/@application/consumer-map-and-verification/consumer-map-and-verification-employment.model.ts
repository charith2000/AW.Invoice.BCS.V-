export interface ConsumerMapAndVerificationEmploymentModel {
  createdAt: string;
  createdBy: string;
  ...
  consumerEmploymentTempId: number;
  consumerEmploymentTemp: ConsumerEmploymentTemp;
  consumerEmploymentValueVerifications: ConsumerEmploymentValueVerification[];
}

export interface ConsumerEmploymentValueVerification {
  id: number;
  rules: Rule[];
  columns: string;
  verification: boolean;
  consumerEmploymentId: number;
  consumerEmployment: string;
}
