export interface ConsumerMapAndVerificationGuarantorModel {
  createdAt: string;
  createdBy: string;
  ...
  consumerGuarantorTempId: number;
  consumerGuarantorTemp: ConsumerGuarantorTemp;
  consumerGuarantorValueVerifications: ConsumerGuarantorValueVerification[];
}

export interface ConsumerGuarantorValueVerification {
  id: number;
  rules: Rule[];
  columns: string;
  verification: boolean;
  consumerGuarantorId: number;
  consumerGuarantor: string;
}
