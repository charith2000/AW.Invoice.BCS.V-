export interface MapAndVerificationSecurity {
  createdAt: string;
  createdBy: string;
  ...
  customerType: string;
  assetCode: string;
  consumerSecurityTempId: number;
  consumerSecurityTemp: ConsumerSecurityTemp;
  consumerSecurityValueVerifications: ConsumerSecurityValueVerification[];
}

export interface ConsumerSecurityValueVerification {
  id: number;
  rules: Rule[];
  columns: string;
  verification: boolean;
  consumerSecurityId: number;
  consumerSecurity: string;
}
